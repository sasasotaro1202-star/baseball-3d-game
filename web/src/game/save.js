...
export function defaultSave(){return{version:1,currency:1000,unlimitedCoins:true,collection:[],team:[],settings:{sound:true,haptics:true},progress:{matches:0,wins:0}};}
